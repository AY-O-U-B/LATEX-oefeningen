...
\noindent \large Oefeningenreeks 2D nr. 8.5\\
...
$\limiet{x \pnR \infty} f(x) = \limiet{x \pnR \infty} x^2 = +\infty$\\

Doordat 2 een even macht is zijn $\pm\infty$ gelijk aan elkaar $= +\infty$\\
