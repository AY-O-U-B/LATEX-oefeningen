...
\textbf{Oefening:} $ \operatorname{Bgtan}(x) + \operatorname{Bgtan}\left(\dfrac{1}{x}\right) $\\

Stel $ x = \tan(\alpha) $ met $ \alpha \in \left]0, \dfrac{\pi}{2}\right[ $\\

Dan geldt $ \dfrac{1}{x} = \dfrac{1}{\tan(\alpha)} = \cot(\alpha) = \tan\left(\dfrac{\pi}{2} - \alpha\right) $\\
