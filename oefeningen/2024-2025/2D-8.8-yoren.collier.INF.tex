...
\noindent \large Oefeningenreeks 2D nr. 8.8\\
...
$\limiet{x \pnR \infty} f(x) = \limiet{x \pnR \infty} -x^3$\\

$\adR \limiet{x \pnR -\infty} -x^3 = -\Lh -\infty \Rh ^3 = -\Lh -\infty \Rh = +\infty$\\

En $\limiet{x \pnR +\infty} -x^3 = -\Lh +\infty \Rh ^3 = -\Lh +\infty \Rh = -\infty$
